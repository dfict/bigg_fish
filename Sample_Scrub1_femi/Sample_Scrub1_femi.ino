...
#include "raaah_table.h"
#include <mozzi_rand.h>
#include <Line.h>
#include <Smooth.h>

// use: Sample <table_size, update_rate, interpolation > SampleName (wavetable)
Sample <RAAAH_TABLE_NUM_CELLS, MOZZI_AUDIO_RATE, INTERP_LINEAR> aSample(RAAAH_TABLE_DATA);
...
if (offset >= RAAAH_TABLE_NUM_CELLS) offset -= RAAAH_TABLE_NUM_CELLS;
if (offset < 0) offset += RAAAH_TABLE_NUM_CELLS;
